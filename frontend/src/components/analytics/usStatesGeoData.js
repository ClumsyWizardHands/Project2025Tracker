// This file contains a simplified GeoJSON representation of US states
// for use with the GeographicHeatMap component

const usStatesGeoData = {
...
export default usStatesGeoData;
